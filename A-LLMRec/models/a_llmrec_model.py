...
class CrossModalAttention(nn.Module):
    ...
    def forward(self, rec_emb, text_emb, return_scores=False):
        ...
        if return_scores:
            # Return attention weights as relevance scores
            return fused, attn
        else:
            # Return fused embedding only
            return fused
...
class A_llmrec_model(nn.Module):
    ...
    def generate(self, data, return_scores=False, return_embeddings=False):
