...
if __name__ == "__main__":
    ...
    # Diversification-related options
    parser.add_argument("--diversify", action="store_true", help="Enable DPP-based diversification")
    parser.add_argument("--top_k", type=int, default=10, help="Top-k items to select during diversification")
    ...
    if args.pretrain_stage1:
        ...
        if args.diversify:
            print(f"Running inference with DPP-based diversification (Top-k: {args.top_k})")
        inference(args)
